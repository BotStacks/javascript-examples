 ...
 */
export declare const withSetPropAction: <T extends IStateTreeNode>(mstInstance: T) => {
    setProp<K extends string | number | symbol, V extends SnapshotIn<T>>(field: K, newValue: V): void;
};
