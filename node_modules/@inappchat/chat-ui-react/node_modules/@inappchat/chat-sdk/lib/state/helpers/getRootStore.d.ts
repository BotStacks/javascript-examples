 ...
 */
export declare const getRootStore: (self: IStateTreeNode) => Instance<IModelType<{
    user_repo: any;
    ...
    users: IOptionalIType<IModelType<import("..").IListStateModelProps & Props & {
        items: IOptionalIType<IArrayType<IReferenceType<T>>, [undefined]>;
    }, import("..").IListStateModelActions & Actions>, [undefined]>;
    groups: IOptionalIType<IModelType<import("..").IListStateModelProps & Props & {
        items: IOptionalIType<IArrayType<IReferenceType<T>>, [undefined]>;
    }, import("..").IListStateModelActions & Actions>, [undefined]>;
    favorites: IOptionalIType<IModelType<import("..").IListStateModelProps & Props & {
        items: IOptionalIType<IArrayType<IReferenceType<T>>, [undefined]>;
    }, import("..").IListStateModelActions & Actions>, [undefined]>;
